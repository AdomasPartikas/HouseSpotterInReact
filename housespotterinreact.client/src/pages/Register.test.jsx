...
describe("Register Component", () => {
  ...
  it("allows the user to register with valid information", async () => {
    ...
    // Fill out the form
    fireEvent.change(screen.getByPlaceholderText("Įveskite savo vartotojo vardą"), { target: { value: "NewUser" } });
    fireEvent.change(screen.getByPlaceholderText("Įveskite savo el. paštą"), { target: { value: "user@example.com" } });
    fireEvent.change(screen.getByPlaceholderText("Įveskite savo tel. nr."), { target: { value: "123456789" } });
    fireEvent.change(screen.getByPlaceholderText("Įveskite savo slaptažodį"), { target: { value: "password" } });
